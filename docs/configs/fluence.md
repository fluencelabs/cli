...
| `chainNetwork`     | string                  | No       | The network in which the transactions will be carried out Possible values are: `kras`, `testnet`, `stage`, `local`.                                                                                                                                                                                                                                                                                                                  |
...
| `ipfsAddr`         | string                  | No       | IPFS multiaddress to use when uploading workers with 'deal deploy'. Default: /dns4/ipfs.fluence.dev/tcp/5001 (for 'workers deploy' IPFS address provided by relay that you are connected to is used)                                                                                                                                                                                                                                 |
