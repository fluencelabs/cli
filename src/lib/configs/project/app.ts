...
const configSchemaV3: JSONSchemaType<ConfigV3> = {
  ...
  description: `[DEPRECATED] Defines what exactly is already deployed and where. This config is automatically generated by Fluence CLI after you deploy services defined in [${FLUENCE_CONFIG_FILE_NAME}](./fluence.md) using \`fluence deploy\` or remove previously deployed services using \`fluence remove\`. In most of the cases you are not expected to modify this by hand`,
  properties: {
    services: {
      type: "object",
      title: "Services",
