                     ...
                     (seq
                      (seq
                       (seq
                        ...
                        (canon %init_peer_id% $error-0  #push-to-stream-808)
                       )
                       (ap #push-to-stream-808 $array-inline-27)
                      )
                 ...
                 (seq
                  (seq
                   (seq
                    ...
                    (canon %init_peer_id% $error  #push-to-stream-826)
                   )
                   (ap #push-to-stream-826 $array-inline-29)
                  )
