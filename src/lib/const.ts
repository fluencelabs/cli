...
export const IPC_CONTAINER_NAME = "ipc";
export const IPC_PORT = 26658;
export const IPC_ETH_CONTAINER_NAME = "ipc-eth";
export const IPC_ETH_PORT = 8545;
export const COMETBFT_CONTAINER_NAME = "cometbft";
